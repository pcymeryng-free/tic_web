    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-blue-600 selection:text-white">
      ...
      <section className="relative overflow-hidden pt-20 pb-32 border-b border-slate-900">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight bg-gradient-to-b from-white to-slate-400 bg-clip-text text-transparent mb-6">
            Navigating the Complexity of Global Telecommunications
          </h1>
          <p className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto mb-10 leading-relaxed">
            International Network Advisors (INA) is a boutique executive consulting firm specializing in telecommunications, regulatory strategy, and market development across the Americas, the Caribbean, and emerging international markets.
          </p>
      ...
      <section id="about" className="py-24 max-w-7xl mx-auto px-6 border-b border-slate-900">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5">
            ...
            <p className="text-3xl font-bold tracking-tight text-white mb-6">
              Cutting through complexity to maximize business ROI.
            </p>
            <p className="text-slate-400 leading-relaxed mb-6">
              Major telecommunications projects are inherently complex; spanning regulatory hurdles, multi-stakeholder environments, and demanding deployment timelines.
            </p>
            <p className="text-slate-400 leading-relaxed">
              INA bridges the gap between regulatory environments, multinational operators, and market-entry strategy, bringing decades of hands-on executive leadership to every engagement.
            </p>
          </div>
          
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { title: 'Strategic Intelligence', desc: 'Data-driven insights and forward-looking strategies to map complex telecommunications landscapes.' },
              { title: 'Regional Expertise', desc: 'Deep jurisdictional understanding across Caribbean, Latin American, and international markets.' },
              { title: 'Global Connectivity', desc: 'Unparalleled access to key decision-makers across regulatory bodies and private sector operators.' }
            ].map((pillar, i) => (
        ...
        {/* VISION BLOCKQUOTE (Corregido con entidades HTML seguras) */}
      ...
      <section id="services" className="py-24 bg-slate-950 border-b border-slate-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-xs font-bold tracking-widest uppercase text-blue-500 mb-3">Advisory Focus</h2>
            <p className="text-3xl md:text-4xl font-bold tracking-tight text-white">
              Targeted Services across Core Practice Areas
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Shield, title: 'Regulatory Strategy', desc: 'Spectrum licensing, compliance frameworks, and government liaison across Caribbean and Latin American jurisdictions.' },
              { icon: TrendingUp, title: 'Commercial Strategy', desc: 'Market entry, pricing architecture, product portfolio development, and revenue optimization.' },
              { icon: Users, title: 'Operator Advisory', desc: 'Strategic counsel to regional telecom operators on growth, M&A readiness, and operational alignment.' },
              { icon: Cpu, title: 'Digital Transformation', desc: 'Technology roadmap development, digital marketing integration, and product innovation advisory.' },
              { icon: Rocket, title: 'Go-to-Market Execution', desc: 'Launch planning, competitive positioning, and commercial rollout strategy.' }
            ].map((service, i) => {
      ...
      <section id="leadership" className="py-24 max-w-7xl mx-auto px-6 border-b border-slate-900">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-xs font-bold tracking-widest uppercase text-blue-500 mb-3">Executive Leadership</h2>
          <p className="text-3xl font-bold tracking-tight text-white">Decades of Operator-Side Advantage</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-4 flex justify-center">
            <div className="w-72 h-96 bg-gradient-to-b from-slate-800 to-slate-950 rounded-lg border border-slate-800 shadow-xl relative overflow-hidden flex items-center justify-center group">
              ...
              <div className="text-center p-6">
                <p className="text-sm font-semibold text-white">Anthony Monaro</p>
                <p className="text-xs text-slate-400 mt-1">Founder & Principal Advisor</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-8 space-y-6">
            <div>
              <h3 className="text-2xl font-bold text-white">Anthony Monaro</h3>
              <p className="text-blue-400 text-sm font-medium mt-1">Founder & Principal Advisor</p>
            </div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              He has held senior executive roles with leading regional operators, spearheading initiatives in network expansion, digital transformation, regulatory engagement, and go-to-market execution. Anthony brings a rare combination of C-suite strategic vision and deep operational expertise making INA uniquely positioned to deliver high-impact advisory outcomes.
            </p>
            <p className="text-slate-400 text-sm leading-relaxed">
              Having worked across multiple jurisdictions, each with its own regulatory, cultural, and commercial dynamics, Anthony brings a rare combination of C-suite strategic vision and deep operational expertise. This operator-side background gives INA clients an insider&apos;s advantage at every stage of engagement.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="reach" className="py-24 bg-slate-950 border-b border-slate-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-xs font-bold tracking-widest uppercase text-blue-500 mb-3">Global Reach</h2>
              <p className="text-3xl font-bold tracking-tight text-white mb-6">
                Strategic Footprint Across Crucial Corridors
              </p>
              <p className="text-slate-400 leading-relaxed mb-8">
                Our advisors maintain active networks across regulatory bodies, multilateral institutions, and private sector operators &mdash; providing clients with unparalleled access to decision-makers and market intelligence across these regions.
              </p>
            ...
            <div className="bg-slate-900/30 border border-slate-900 rounded-xl p-8 h-80 flex flex-col justify-center relative overflow-hidden">
              ...
              <div className="space-y-4 relative z-10">
                ...
                <p className="text-xs text-slate-400 leading-relaxed max-w-md">
                  Connecting cross-market regulatory dynamics with corporate operational goals to maintain unique insider positioning.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="contact" className="py-24 max-w-7xl mx-auto px-6">
        <div className="max-w-4xl mx-auto rounded-xl bg-gradient-to-b from-slate-900 to-slate-950 border border-slate-900 p-8 md:p-12">
          <div className="text-center mb-10">
            <h2 className="text-xs font-bold tracking-widest uppercase text-blue-500 mb-3">Contact</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            <div className="md:col-span-5 space-y-6">
              <p className="text-sm text-slate-400 leading-relaxed">
                Reach out to our principal advisors to discuss regulatory strategy, market entry, or operational alignment.
              </p>
